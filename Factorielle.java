class Factorielle {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (nbEntiers < 0) {
                throw new NegativeException(nbEntiers + " est négatif : le factorielle d'un nombre négatif n'est pas définie.");
            }

             if (nbEntiers <= 20) {
                throw new GrandException(nbEntiers + " est grand : donner un nombre qui ne depasse pas la plage de valeur");
            }
